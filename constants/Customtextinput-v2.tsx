...
// Import Ionicons for default icons (optional dependency)
let Ionicons: any;
try {
    Ionicons = require('@expo/vector-icons').Ionicons;
} catch (e) {
    // Ionicons not available - user must provide custom icons
}
...
interface CustomTextInputProps extends Omit<TextInputProps, 'style'> {
    ...
    // Icons (can be React element or icon name string)
    leftIcon?: ReactNode;
    rightIcon?: ReactNode;
    ...
    clearButtonIcon?: ReactNode; // Custom clear icon
                ...
                >
                        ...
                        >
                            {clearButtonIcon || (
                                Ionicons ? (
                                    ...
                                    <Text style={{ fontSize: clearButtonSize, color: clearButtonColor }}>✕</Text>
                                )
                            )}
                        </TouchableOpacity>
                    )}
                    ...
                    {shouldShowPasswordToggle && !shouldShowClearButton && (
                        ...
                        >
                            {isPasswordVisible
                                ? (passwordVisibleIcon || (
                                    Ionicons && <Ionicons name="eye-off" size={passwordToggleSize} color={passwordToggleColor} />
                                ))
                                : (passwordHiddenIcon || (
                                    Ionicons && <Ionicons name="eye" size={passwordToggleSize} color={passwordToggleColor} />
                                ))
                            }
                        </TouchableOpacity>
                    )}
